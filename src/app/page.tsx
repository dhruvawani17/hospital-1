        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={item.title} className="text-center animate-slide-in-up" style={{animationDelay: `${0.2 * (index + 1)}s`}}>
                <CardHeader>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredServices.map((service, index) => (
              <Card key={service.id} className="overflow-hidden animate-slide-in-up" style={{animationDelay: `${0.2 * (index + 1)}s`}}>
                <Image
                  src={service.image}
                  alt={service.name}
                  width={600}
